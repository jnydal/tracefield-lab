      ...
      <div className="about-shell">
        <div className="about-hero-card">
          ...
          <div className="about-hero-card-visual" aria-hidden="true">
            <img
              src="/images/about-pipeline.png"
              alt="Tracefield Lab pipeline: Ingest, Entity mapping with exact and semantic resolution, Analysis"
        ...
        <div className="about-content-card">
          <div>
            ...
            <p className="about-content-copy">
              ...
              of finding candidate confounders and unexpected associations still rests entirely with
              the researcher.
            </p>
            <p className="about-content-copy">
